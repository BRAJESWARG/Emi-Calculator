...
const CalculateEmi = () => {
    ...
    return (
        <div className='CalculateEmi'>
            {toggle ? (
                <div className="CalculatorBox">
                    <h1>EMI Calculator</h1>
                    <form onSubmit={handleButtonsubmit} id="sample-form" method="post" >
                        <p>Amount (₹):
                            <input id="amount" type="number" required name='amount' value={data.amount} placeholder="Please Enter Your Amount" onChange={calculate} />
                        </p>
                        <p>Interest Rate  :
                            <input id="rate" type="number" required name='rate' value={data.rate} placeholder="Please Enter your Rate" onChange={calculate} />
                        </p>
                        <p>Months to Pay :
                            <input id="months" type="number" required name='months' value={data.months} placeholder="Please Enter your Month" onChange={calculate} />
                        </p>
